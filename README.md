...
## v0.3 Interactive Timeline

- Timeline scrub/playhead renders the selected instant directly in Design.
- Drag timing start/end handles and bars like a compact motion editor.
- Separate entry/exit duration per layer.
- Play/Pause with 0.25x–2x preview playback speed.
- Global 1/2-time and 2x-time stretching for entry or exit.
- Operator mode shows PROGRAM only; staging remains internal until ENVIAR AL AIRE.
